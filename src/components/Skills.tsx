...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: "Deep Learning", level: 85, color: "from-gray-400 to-gray-700", icon: "🔧" },
    { name: "NLP", level: 65, color: "from-green-400 to-teal-600", icon: "🗄️" }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Git', 'Computer Vision', 'LLMs', 'HuggingFace Transformers', 'LangChain', 'SQL', 'Notion', 'Google Colab','Docker'].map((tech, index) => (
              <span 
                key={tech}
